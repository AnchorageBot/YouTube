/* This sketch will test all the sensors on the Adafruit Bluefruit Sense
 *  9-DoF Motion (Gyro & Magnetometer), Proximity/Light/Color/Gesture, 
 *  Microphone/Sound, Humidity, Temperature, Barometric Pressure 
 *  
 * Materials Schedule
