# This script uses a for loop, Variables & Lists to light neopixels on the CPB with CircuitPython
...
for NeoPixelNumber in range(5):                 # Variable - NeoPixelNumber, range runs across the list [0, 1, 2,3,4]
    pixels[NeoPixelNumber] = (255,0,255)
    time.sleep(0.5)
                                                # Program stops after one run
